        ...
        <div className='my-10 '>
            ...
            <div className="container_wrapper bg-ch-neutrals-2 py-10">
                <div className="flex justify-center">
                    <Link className="box hover:bg-ch-primary-1 hover:text-ch-white flex flex-col justify-center items-center mr-10 p-10 bg-ch-white shadow w-[400px]">
                    ...
                    <Link className="box hover:bg-ch-primary-1 hover:text-ch-white flex flex-col justify-center items-center   p-10 bg-ch-white shadow w-[400px]">
